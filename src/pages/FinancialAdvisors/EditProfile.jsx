...
const EditAdvisorProfile = ({onSubmit, initialData = {}}) => {
    const states = [
    ...
    return (
        <div className="card p-5 mt-1 mb-4 shadow-sm border-0">
            ...
            <form className="pt-4" onSubmit={handleSubmit}>
                ...
                <div className="d-flex justify-content-between mt-5 pt-5 gap-3">
...
export default EditAdvisorProfile; // ✅ Default export
